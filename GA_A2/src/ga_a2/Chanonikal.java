...
public class Chanonikal {
    ...
    int caseNum;
    int respondArr[];
    double MinError = 0;int  Counter = 0, IndexOfBest = 0;
    ...
    public boolean Terminate() {
        for (int i = 0; i < numOfPop; i++) {
            if (chroms[i].fitness == MinError) {
                Counter++;
                IndexOfBest = i;
                System.err.println("Max Benefit : " + MinError + " With index " + IndexOfBest + " Counter " + Counter);
            } else if (chroms[i].fitness < MinError &&chroms[i].fitness<=3) {
                MinError = chroms[i].fitness;
                Counter = 1;
                IndexOfBest = i;
                System.err.println("Max Benefit : " + MinError + " With index " + IndexOfBest + " Counter " + Counter);
            }
        ...
        if (Counter == 3) {
            System.out.println("Termenation Condition ,Min Error  : " + MinError + " With index : " + IndexOfBest + " Counter" + Counter);
            return true;
        }
        return false;
    }
